...
#app(:class="[(!ws.disableDemo?'demo':''),(fullscreen?'nocursor':'')]")
  ...
  b-navbar.bd-navbar(toggleable="md" type="dark")
    ...
    b-navbar-brand(@click="showAlert='с 14:00 по 18:00 будут профилактические работы'")
      .logo
    b-navbar-brand(@click="$root.toggleFullScreen()") BMS 
      span.w100 Диспетчерская
    ...
    b-navbar-nav.ml-2
      b-nav-form
        b-button(size="sm" variant="primary") 
          | Create
      b-nav-item 70 ЖК
      b-nav-item 242 Домов
      b-nav-item 1193 Котеджей

    b-navbar-nav.ml-2
      b-nav-item 230 Заявок
      b-nav-item 15 Бригад
...
// <style lang="stylus" src="./AppStylesQueue.stylus"/>